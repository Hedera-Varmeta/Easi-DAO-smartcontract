    ...
    GovernorUpgradeable
{
    ...
    mapping(bytes32 => ProposalDetails) private _proposalDetails;
     ...
     */
    function queue(bytes32 proposalId) public virtual override {
     ...
     */
    function execute(bytes32 proposalId) public payable virtual override {
        ProposalDetails storage details = _proposalDetails[proposalId];
        execute(
            details.targets,
            details.values,
    ...
    function cancel(bytes32 proposalId) public virtual override {
        ProposalDetails storage details = _proposalDetails[proposalId];
